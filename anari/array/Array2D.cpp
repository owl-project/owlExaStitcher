...
Array2D::Array2D(ExaStitchGlobalState *state, const Array2DMemoryDescriptor &d)
...
anari::uint2 Array2D::size() const
{
  return anari::uint2(uint32_t(size(0)), uint32_t(size(1)));
}
...
EXA_ANARI_TYPEFOR_DEFINITION(exa::Array2D *);
