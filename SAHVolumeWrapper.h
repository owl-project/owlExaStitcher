...
namespace exa {
  ...
  // Wrapper for ExaBricks volume to compute SAH majorant kd-trees
  struct SAHVolumeWrapper
  {
    box3f cellBounds;
    range1f xfDomain;
    ExaBrickSamplerCPU::SP sampler = nullptr;

    SAHVolumeWrapper(ExaBrickModel::SP model, const std::vector<float> *rgbaCM = nullptr,
