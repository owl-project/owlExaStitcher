...
BRICKS="-bricks /home/zellmann/exabuilder/build/meteor-20060.morton.bricks"
#BRICKS="-bricks /home/zellmann/exabuilder/build/meteor-20060.projection.bricks"
SCALARS="-scalars /mnt/raid/zellmann/exa/meteor-20k/meteor-20060.exa.tev.scalars"
...
do
  ...
  do
    ...
    ${BUILD_DIR}/exaStitchHeadlessViewer ${BRICKS} ${KDTREE} ${SCALARS} ${MESH} ${CAMERA} ${XF} ${NUM_MCS} ${LIGHT} ${CLIP_PLANE} ${IMG_SIZE} ${outfile} ${fpsfile} -rt 2 2>&1 | tee meteor-20k.out
  done
done
